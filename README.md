...
| **리뷰** | `/review` | 스태프 엔지니어 | N+1 쿼리·레이스 컨디션 등 프로덕션 버그 탐지, AUTO-FIX/ASK 모드 |
...
| **배포** | `/ship` | 릴리스 엔지니어 | 테스트 → 커버리지 감사 → 푸시 → PR 생성을 한 명령으로 |
...
| | `/connect-chrome` | Chrome 연결 | 실제 Chrome을 연결하여 Side Panel에서 실시간 활동 피드 확인 |
...
*gstack v0.14.1.0 기준 · 마지막 업데이트: 2026년 3월 30일*
